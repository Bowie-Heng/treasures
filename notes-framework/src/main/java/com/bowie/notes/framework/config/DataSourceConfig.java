...
/**
 * Created by Bowie on 2019/4/17 16:06
 * 数据源和分表配置
 **/
@Configuration
@MapperScan(basePackages = "com.bowie.notes.framework.dao", sqlSessionTemplateRef = "test1SqlSessionTemplate")
